export default function Home() {
  return (
    <main className="flex items-center flex-col overflow-x-hidden overflow-y-hidden">
      ...
      <div className="bg-[linear-gradient(to_bottom,_white_0%,_#ECDFD1_40%,_#C4DCF4_100%)]">
        <div className="hero2 w-[100vw] h-[300px] flex flex-col items-center justify-start">
        ...
        <div className="hero10 w-[100vw] h-[500px] flex flex-col items-center justify-start mt-20">
          ...
          <div className="hero10-content w-[100vw] flex items-center justify-center gap-5 mt-10">
            <div className="content-card w-[450px] bg-white/70 backdrop-blur-md border-b border-gray-200 rounded-3xl p-7">
              <div className="content-card-head flex items-center justify-between">
                <img src="./images/x-logo.png" className="h-[60px] w-[60px] object-cover rounded-2xl" alt="" />
                <div className="text-[14px] font-semibold text-[#757170]">15.2K FOLLOWERS</div>
              </div>
              <div className="content-card-content flex flex-col">
                <div className="content-card-content-head text-[24px] font-semibold mt-10"> X/Twitter</div>
                <div className="content-left-content-body text-[16px] text-[#453F3D] mt-2">Stay updated on new features and discover how others are using Dreelio.</div>
              </div>
              <div className="content-left-footer flex items-center mt-10">
                <button className="flex items-center text-[16px] border-2 border-gray-200 justify-center font-bold py-4 px-6 rounded-full">Floow us</button>
              </div>
            </div>

            <div className="content-card w-[450px] bg-white/70 backdrop-blur-md border-b border-gray-200 rounded-3xl p-7">
              <div className="content-card-head flex items-center justify-between">
                <img src="./images/youtube-logo.png" className="h-[60px] w-[60px] object-cover rounded-2xl" alt="" />
                <div className="text-[14px] font-semibold text-[#757170]">32K SUBSCRIBERS</div>
              </div>
              <div className="content-card-content flex flex-col">
                <div className="content-card-content-head text-[24px] font-semibold mt-10">YouTube</div>
                <div className="content-card-content-body text-[16px] text-[#453F3D] mt-2">Tips, tutorials, and in-depth feature guides to inspire and enhance your Dreelio workflow.</div>
              </div>
              <div className="content-card-footer flex items-center mt-10">
                <button className="flex items-center text-[16px] border-2 border-gray-200 justify-center font-bold py-4 px-6 rounded-full">Subscribe</button>
              </div>
            </div>
          </div>
        </div>
